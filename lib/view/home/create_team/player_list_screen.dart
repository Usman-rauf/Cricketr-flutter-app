...
import 'package:cricketly/view/home/create_team/team_over_view_screen.dart';
...
class PlayerListScreen extends StatefulWidget {
  ...
  const PlayerListScreen({super.key, required this.teamName});
      ...
      child: MaterialButton2(
        ...
        onPressed: () {
          ...
          if (totalSelectedPlayer.length < 2) {
            ...
            Fluttertoast.showToast(
                msg: "You have already selected 11 players.",
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.CENTER,
                timeInSecForIosWeb: 1,
                backgroundColor: Colors.red,
